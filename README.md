...
Future Work
	•	Investigating how this encoding impacts compression ratios for Huffman Encoding.
	•	Exploring variations that minimize bit-length increase while preserving compression benefits.
